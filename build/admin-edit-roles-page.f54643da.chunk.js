(self.webpackChunkvitamin_bd=self.webpackChunkvitamin_bd||[]).push([[2544],{23341:(X,B,r)=>{"use strict";r.r(B),r.d(B,{CreatePage:()=>Ee,default:()=>$e});var e=r(67294),b=r(185),P=r(53979),R=r(11047),Z=r(29728),O=r(49066),S=r(41580),x=r(75515),D=r(11276),_=r(67819),a=r(16364),H=r(61467),p=r(86819),A=r(67109),F=r(66115),f=r(41054),C=r(27361),w=r.n(C),me=r(41609),ie=r.n(me),le=r(86896),y=r(86706),ce=r(16550),Y=r(88972),G=r(35650),ee=r(99369),xe=r(18280),pe=r(87561);const oe=pe.Ry().shape({name:pe.Z_().required(p.I0.required),description:pe.Z_().required(p.I0.required)}),Pe=Y.ZP.div`
