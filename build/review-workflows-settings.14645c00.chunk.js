...
`;function se({children:a,...r}){return e.createElement(ce,{as:"button",background:"neutral0",border:"neutral150",paddingBottom:3,paddingLeft:4,paddingRight:4,paddingTop:3,shadow:"filterShadow",...r},e.createElement(c.k,{gap:2},e.createElement(Y,{"aria-hidden":!0}),e.createElement(P.Z,{variant:"pi",fontWeight:"bold",textColor:"neutral500"},a)))}se.propTypes={children:h().node.isRequired};var ue=t(63237),le=t(48734),ie=t(74756),J=t(12028),ke=t(63081),be=t(11276),ve=t(67819),Ce=t(16364),we=t(70642),De=t(20022),$e=t(12814),We=t(61080),Re=t(75642),Pe=t(13920),ge=t(13037);const Te=(0,ge.s)();function je(){return e.createElement(W.x,{background:"primary100",borderStyle:"dashed",borderColor:"primary600",borderWidth:"1px",display:"block",hasRadius:!0,padding:6,shadow:"tableShadow"})}function ye({id:a,index:r,canDelete:o,canReorder:C,isOpen:p=!1,stagesCount:m}){const d=g=>`${g+1} of ${m}`,M=g=>{z(D({id:"dnd.grab-item",defaultMessage:"{item}, grabbed. Current position in list: {position}. Press up and down arrow to change position, Spacebar to drop, Escape to cancel."},{item:$.value,position:d(g)}))},U=g=>{z(D({id:"dnd.drop-item",defaultMessage:"{item}, dropped. Final position in list: {position}."},{item:$.value,position:d(g)}))},pe=()=>{z(D({id:"dnd.cancel-item",defaultMessage:"{item}, dropped. Re-order cancelled."},{item:$.value}))},N=(g,ae)=>{z(D({id:"dnd.reorder",defaultMessage:"{item}, moved. New position in list: {position}."},{item:$.value,position:d(g)})),G(B(ae,g))},[de,z]=e.useState(null),{formatMessage:D}=(0,j.Z)(),{trackUsage:_}=(0,v.rS)(),G=(0,i.I0)(),[V,he]=e.useState(p),[$,fe]=(0,k.U$)(`stages.${r}.name`),[O,ee]=(0,k.U$)(`stages.${r}.color`),[{handlerId:A,isDragging:te,handleKeyDown:H},Ge,Ve,He,Se]=(0,Re.Y9)(C,{index:r,item:{name:$.value},onGrabItem:M,onDropItem:U,onMoveItem:N,onCancel:pe,type:s.uL.STAGE}),Qe=(0,Pe.FE)(Ge,Ve),Xe=Te.map(({hex:g,name:ae})=>({value:g,label:D({id:"Settings.review-workflows.stage.color.name",defaultMessage:"{name}"},{name:ae}),color:g}));e.useEffect(()=>{Se((0,We.rX)(),{captureDraggingState:!1})},[Se,r]);const{themeColorName:Ye}=O.value?(0,ge.k)(O.value):{};return e.createElement(W.x,{ref:Qe},de&&e.createElement(ue.T,{"aria-live":"assertive"},de),te?e.createElement(je,null):e.createElement(le.U,{size:"S",variant:"primary",onToggle:()=>{he(!V),V||_("willEditStage")},expanded:V,shadow:"tableShadow"},e.createElement(ie.B,{title:$.value,togglePosition:"left",action:e.createElement(c.k,null,o&&e.createElement(J.h,{background:"transparent",icon:e.createElement(De.Z,null),label:D({id:"Settings.review-workflows.stage.delete",defaultMessage:"Delete stage"}),noBorder:!0,onClick:()=>G(K(a))}),e.createElement(J.h,{background:"transparent",forwardedAs:"div",role:"button",noBorder:!0,tabIndex:0,"data-handler-id":A,ref:He,label:D({id:"Settings.review-workflows.stage.drag",defaultMessage:"Drag"}),onClick:g=>g.stopPropagation(),onKeyDown:H},e.createElement($e.Z,null)))}),e.createElement(ke.v,{padding:6,background:"neutral0",hasRadius:!0},e.createElement(be.r,{gap:4},e.createElement(ve.P,{col:6},e.createElement(Ce.o,{...$,id:$.name,label:D({id:"Settings.review-workflows.stage.name.label",defaultMessage:"Stage name"}),error:fe.error??!1,onChange:g=>{$.onChange(g),G(I(a,{name:g.target.value}))},required:!0})),e.createElement(ve.P,{col:6},e.createElement(we.q4,{error:ee?.error??!1,id:O.name,required:!0,label:D({id:"content-manager.reviewWorkflows.stage.color",defaultMessage:"Color"}),onChange:g=>{O.onChange({target:{value:g}}),G(I(a,{color:g}))},value:O.value.toUpperCase(),startIcon:e.createElement(c.k,{as:"span",height:2,background:O.value,borderColor:Ye==="neutral0"?"neutral150":"transparent",hasRadius:!0,shrink:0,width:2})},Xe.map(({value:g,label:ae,color:Me})=>{const{themeColorName:Je}=(0,ge.k)(Me);return e.createElement(we.ag,{value:g,key:g,startIcon:e.createElement(c.k,{as:"span",height:2,background:Me,borderColor:Je==="neutral0"?"neutral150":"transparent",hasRadius:!0,shrink:0,width:2})},ae)})))))))}ye.propTypes=h().shape({id:h().number.isRequired,color:h().string.isRequired,canDelete:h().bool.isRequired,canReorder:h().bool.isRequired,stagesCount:h().number.isRequired}).isRequired;const Ie=(0,L.ZP)(W.x)`
  position: relative;
`,Ae=(0,L.ZP)(W.x)`
  left: 50%;
  position: absolute;
